<template>
    <div class="mg-news">
        <el-dialog title="拆票(货转)操作" :visible.sync="dialogFormVisible">
            <el-form :inline="true" ref="addForm" :model="addForm" label-width="150px" size="medium">
                <div>
                    <el-form-item label="原货物信息">
                    ...
                    <el-form-item label="原货物数量">
                        ...
                        <span class="sub-title">(货物重量随新客户数量递减)</span>
                    </el-form-item>
                </div>
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <!--<el-button style="margin-right:10px;" type="primary"-->
                                   <!--icon="el-icon-view"-->
                                   <!--@click="dialogFormVisible = true">查看库位图-->
                        <!--</el-button>-->
