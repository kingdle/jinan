<template>
    <div class="mg-news">
        <el-dialog title="新增客户联系人" :visible.sync="dialogFormVisible">
            <el-form ref="addForm" :model="addForm" label-width="80px" size="medium">
                ...
                <el-form-item label="地址">
                    <el-input v-model="addForm.goods_name"
                              clearable
                              placeholder="山东省青岛市*区*路*号">
                    </el-input>
                </el-form-item>
                <el-form-item label="网址">
                    <el-input v-model="addForm.packing"
                              clearable
                              placeholder="www.hlqgroup.com"></el-input>
                </el-form-item>
                <el-form-item label="邮箱">
                    <el-input v-model="addForm.number_id"
                              clearable
                              placeholder="18661737287@qq.com">
                    </el-input>
                </el-form-item>
                <el-form-item label="联系人">
                    <el-input v-model="addForm.extract_id"
                              clearable
                              placeholder="金多"></el-input>
                </el-form-item>
                <el-form-item label="电话">
                    <el-input v-model="addForm.phone"
                              clearable
                              placeholder="18661737287"></el-input>
                </el-form-item>
        ...
        <el-dialog title="新增客户联系人" :visible.sync="addFeeFormVisible">
            <el-row>
                <el-row>
                    <el-col :span="8">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-button style="margin-right:10px;" type="primary"
                                   ...
                                   @click="dialogFormVisible = true">新增用户
                        </el-button>
