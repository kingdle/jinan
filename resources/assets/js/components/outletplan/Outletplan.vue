<template>
    <div class="mg-news">
        <el-dialog title="新建出库计划" :visible.sync="dialogFormVisible">
        ...
        <el-dialog title="乾通源物流货物出库单" :visible.sync="printFeeFormVisible">
            <el-row>
                <el-row>
                    <el-col :span="12">
                        <div class="grid-content bg-purple">
                            经营单位：{{receivablesForm.fee_receivable}}
                        </div>
                    </el-col>
                    <el-col :span="12">
                        <div class="grid-content bg-purple">
                            货主单位：{{receivablesForm.fee_payable}}
                        </div>
                    </el-col>
                    <el-col :span="12">
                        <div class="grid-content bg-purple">
                            报关单号：{{receivablesForm.fee_payable}}
                        </div>
                    </el-col>
                    <el-col :span="12">
                        <div class="grid-content bg-purple">
                            提单号：{{receivablesForm.fee_payable}}
                        </div>
                    </el-col>
                </el-row>
            </el-row>
            <el-form class="fee-add" :inline="true" ref="addFeeForm" label-width="120px"
                     size="medium">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button @click="printFeeFormVisible = false">关闭窗口</el-button>
            </div>
        </el-dialog>
        <el-container>
            <el-header
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <!--<el-button style="margin-right:10px;" type="primary"-->
                                   ...
                                   <!--@click="dialogFormVisible = true">新建出库计划-->
                        <!--</el-button>-->
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-tooltip class="item" effect="dark"
                            ...
                            <el-button
                                    ...
                                    type="primary" icon="el-icon-circle-check-outline"
                                    size="mini" circle>
                            </el-button>
                        </el-tooltip>
                        <el-tooltip class="item" effect="dark"
                            ...
                            <el-button
                                    ...
                                    @click.native.prevent="handlePrint(scope.$index, scope.row)"
...
//            this.queryDepartment = this.loadDepartments()
        ...
        methods: {
            ...
            handlePrint(index, row) {
                axios.get('/api/v1/printInletPlan/' + row.id).then(response => {
