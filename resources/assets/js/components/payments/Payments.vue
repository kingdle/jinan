<template>
    <div class="mg-news">
        <el-dialog title="付费" :visible.sync="dialogFormVisible">
        ...
        <el-dialog title="付费信息录入申请" :visible.sync="addFeeFormVisible">
            ...
            <el-form class="fee-add" :inline="true" ref="addFeeForm" :model="addFeeForm" label-width="120px" size="medium">
                <el-form-item label="客户名称">
                    <el-input class="textarea-width" type="input"
                              clearable
                              placeholder="青岛乾通源物流有限公司"></el-input>
                </el-form-item>
                <el-form-item label="提单号">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-button style="margin-right:10px;" type="primary"
                                   ...
                                   @click="dialogFormVisible = true">新建申请
                        </el-button>
