<template>
    <div class="mg-news">
        <el-dialog title="新建客户收（付）款明细" :visible.sync="dialogFormVisible" :fullscreen="true">
            <el-form :inline="true" ref="addForm" :model="addForm" label-width="130px" size="medium">
                ...
                <el-form-item label="箱量净重">
                    <el-input v-model="addForm.weight_box"
                ...
                <el-form-item label="协议包干单价">
                    <el-input v-model="addForm.price_income_package"
                ...
                <el-form-item label="实际包干单价">
                    <el-input v-model="addForm.price_cost_package"
                ...
                <div class="group-input">
                    <el-form-item label="包干费收入-小计">
                        <el-input v-model="addForm.fee_bale_receivable"
                    ...
                    <el-form-item label="紧急成本附加费">
                        <el-input v-model="addForm.fee_emergency_receivable"
                                  @input="emergencyReceivableChange($event)"
                                  clearable
                                  placeholder="0.00">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="堆存保管费">
                        <el-input v-model="addForm.fee_storage_receivable"
                                  @input="storageReceivableChange($event)"
                                  clearable
                                  placeholder="8.09">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="修洗箱费">
                        <el-input v-model="addForm.fee_cleaning_box_receivable"
                                  @input="cleaningBoxReceivableChange($event)"
                                  clearable
                                  placeholder="8.30">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="调箱费">
                        <el-input v-model="addForm.fee_adjusting_box_receivable"
                                  @input="adjustingBoxReceivableChange($event)"
                                  clearable
                                  placeholder="0.00">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="代理修箱费">
                        <el-input v-model="addForm.fee_repair_box_receivable"
                                  @input="adjustingBoxReceivableChange($event)"
                                  clearable
                                  placeholder="0.00">
                            <template slot="prepend">￥</template>
                    ...
                    <el-form-item label="代垫费用-小计">
                        <el-input v-model="addForm.fee_before_receivable"
                                  placeholder="0.00"
                                  clearable
                                  :disabled="true">
                            <template slot="prepend">￥</template>
                    ...
                    <el-form-item label="应收合计">
                        <el-input placeholder="0.00" :disabled="true" v-model="addForm.fee_receivable">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                </div>
                <div class="group-input">
                    <el-form-item label="换单费">
                        <el-input v-model="addForm.fee_exchange_payable"
                                  clearable
                                  placeholder="8.09">
                            <template slot="prepend">￥</template>
                        </el-input>
                    ...
                    <el-form-item label="港杂费">
                        <el-input v-model="addForm.fee_harbor_payable"
                                  clearable
                                  placeholder="640元普票500元专票">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="代理报关费">
                        <el-input v-model="addForm.fee_customs_payable"
                                  clearable
                                  placeholder="100元/票（专票)">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="报检代理费">
                        <el-input v-model="addForm.fee_inspection_agent_payable"
                                  clearable
                                  placeholder="50元/票(专票)">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="商检验货代理费">
                        <el-input v-model="addForm.fee_inspection_goods_payable"
                                  clearable
                                  placeholder="60元/票(专票)">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="商检查验费">
                        <el-input v-model="addForm.fee_inspection_payable"
                                  clearable
                                  placeholder="12.08">
                            <template slot="prepend">￥</template>
                        </el-input>
                    ...
                    <el-form-item label="检验检疫费">
                        <el-input v-model="addForm.fee_inspection_quarantine_payable"
                                  clearable
                                  placeholder="201.60">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="掏箱费">
                        <el-input v-model="addForm.fee_dig_box_payable"
                                  clearable
                                  placeholder="110.00">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="短途运费">
                        <el-input v-model="addForm.fee_transport_short_payable"
                                  clearable
                                  placeholder="（20尺*1/车）*330">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="包干费成本-小计">
                        <el-input v-model="addForm.fee_bale_payable"
                                  placeholder="0.00"
                                  clearable
                                  :disabled="true">
                            <template slot="prepend">￥</template>
                    ...
                    <el-form-item label="代垫费用-小计">
                        <el-input v-model="addForm.fee_before_payable"
                                  placeholder="0.00"
                                  clearable
                                  :disabled="true">
                            <template slot="prepend">￥</template>
                    ...
                    <el-form-item label="应付合计">
                        <el-input v-model="addForm.fee_payable"
                                  placeholder="0.00"
                                  clearable
                                  :disabled="true">
                            <template slot="prepend">￥</template>
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-button style="margin-right:10px;" type="primary"
                                   ...
                                   @click="dialogFormVisible = true">货物登记
                        </el-button>
    ...
    export default {
        data() {
            return {
                ...
                pagerCount: 5,
                addForm: {
//                    price_income_package: '0',
//                    price_cost_package: '0',
//                    fee_receivable: '0',
//                    fee_bale_receivable: '0',
//                    fee_before_receivable: '0',
//                    fee_emergency_receivable: '0',
//                    fee_storage_receivable: '0',
//                    fee_cleaning_box_receivable: '0',
//                    fee_adjusting_box_receivable: '0',
//                    fee_repair_box_receivable: '0',
//                    fee_payable: '0',
//                    fee_bale_payable: '0',
//                    fee_before_payable: '0',
//                    fee_exchange_payable: '0',
//                    fee_harbor_payable: '0',
//                    fee_customs_payable: '0',
//                    fee_inspection_agent_payable: '0',
//                    fee_inspection_goods_payable: '0',
//                    fee_inspection_payable: '0',
//                    fee_inspection_quarantine_payable: '0',
//                    fee_dig_box_payable: '0',
//                    fee_transport_short_payable: '0',
//                    fee_emergency_payable: '0',
//                    fee_storage_payable: '0',
//                    fee_cleaning_box_payable: '0',
//                    fee_adjusting_box_payable: '0',
//                    fee_repair_box_payable: '0',
                },
                editForm: {},
                copyForm: {},
